...
\begin{figure}[h]
	%\vspace{-3mm}
	\centering
	\includegraphics[width=0.6\textwidth]{figures/jieyue-sudu-partC.png}
	%\vspace{-2mm}
...
\begin{figure*}[h!]
	...
	{\includegraphics[width=0.45\textwidth]{figures/CACC_closed_loop.png}
		\label{fig-cacc-closed-loop}}
	\hspace{4mm}
	\subfigure[String stability]
	{\includegraphics[width=0.45\textwidth]{figures/CACC_string_stability.png}
...
\begin{figure*}[h!]
	...
	{\includegraphics[width=0.45\textwidth]{figures/delay-1500ms-speed-partC.png}
		\label{fig-exp-delay-velocity}}
	\hspace{4mm}
	\subfigure[Inter-vehicle distance profiles]
	{\includegraphics[width=0.45\textwidth]{figures/delay-1500ms-distance-partC.png}
